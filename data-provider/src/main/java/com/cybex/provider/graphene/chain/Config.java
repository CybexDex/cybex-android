...
public class Config {
    ...
    public static final String GRAPHENE_ADDRESS_PREFIX       = "CYB";
...
///@}
    ...
    public static final ObjectId<AssetObject> asset_object_base = new ObjectId<AssetObject>(0, AssetObject.class);
}
