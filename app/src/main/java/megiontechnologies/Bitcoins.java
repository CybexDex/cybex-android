...
public final class Bitcoins implements Serializable {
     ...
     * BitcoinJ would already output megiontechnologies.Bitcoins instead of BigInteger
     *
     * @param output
     ...
     */
    /*
     * public static megiontechnologies.Bitcoins valueOf(TransactionOutput output) { return
     * megiontechnologies.Bitcoins.valueOf(output.getValue().longValue()); }
     */
