...
import mrd.bitlib.crypto.BitcoinSigner;
import mrd.bitlib.crypto.IPrivateKeyRing;
import mrd.bitlib.crypto.IPublicKeyRing;
import mrd.bitlib.crypto.PublicKey;
import mrd.bitlib.model.*;
import mrd.bitlib.util.ByteWriter;
import mrd.bitlib.util.CoinUtil;
...
import static mrd.bitlib.TransactionUtils.MINIMUM_OUTPUT_VALUE;
