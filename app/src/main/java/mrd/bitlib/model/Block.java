...
import mrd.bitlib.model.Transaction.TransactionParsingException;
import mrd.bitlib.util.ByteReader;
import mrd.bitlib.util.ByteWriter;
import mrd.bitlib.util.HashUtils;
import mrd.bitlib.util.Sha256Hash;
import mrd.bitlib.util.ByteReader.InsufficientBytesException;
...
public class Block {
   ...
   public int nonce;
   // Transactions
   public mrd.bitlib.model.Transaction[] transactions;
   ...
   public static Block fromBlockStore(ByteReader reader) throws BlockParsingException {
      try {
         ...
         mrd.bitlib.model.Transaction[] transactions = new mrd.bitlib.model.Transaction[numTransactions];
         for (int i = 0; i < numTransactions; i++) {
            try {
               transactions[i] = mrd.bitlib.model.Transaction.fromByteReader(reader);
