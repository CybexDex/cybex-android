...
public class PortfolioListRecyclerViewAdapter extends RecyclerView.Adapter<PortfolioListRecyclerViewAdapter.ViewHolder> {
    ...
    private List<account_balance_object> mAccountBalanceObjectList;

    public PortfolioListRecyclerViewAdapter(List<account_balance_object> accountBalanceObjectList) {
