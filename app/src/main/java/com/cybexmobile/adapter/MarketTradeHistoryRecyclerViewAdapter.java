 ...
 */
public class MarketTradeHistoryRecyclerViewAdapter extends RecyclerView.Adapter<MarketTradeHistoryRecyclerViewAdapter.ViewHolder> {

    private final List<MarketTrade> mValues;
    private final Context mContext;
    private WatchlistData mWatchlistData;

    public MarketTradeHistoryRecyclerViewAdapter(List<MarketTrade> items, WatchlistData watchlistData, Context context) {
        mValues = items;
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_market_trade_history, parent, false);
