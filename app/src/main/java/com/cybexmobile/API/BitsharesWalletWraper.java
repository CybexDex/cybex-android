...
public class BitsharesWalletWraper {
    ...
    private List<full_account_object> mFullAccountObjects = new ArrayList<>();
    private List<object_id<asset_object>> mObjectList = new ArrayList<>();
...
//    }
    ...
    public List<full_account_object> getMyFullAccountInstance() {
        return mFullAccountObjects;
    }
    //Todo: add asset_object_to_id_map
//    public List<object_id<asset_object>> getObjectList() {
